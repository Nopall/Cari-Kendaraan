...
<head>
    <title>Cari Kendaraan | Mobil</title>
...
<body>
    ...
    @include('header')
        <div class="container">
            <h1 class="page-title">Cari Mobil Impianmu</h1>
        </div>
        ...
        <div class="container">
            <form>
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group form-group-icon-left"><i class="fa fa-map-marker input-icon input-icon-hightlight"></i>
                            ...
                            <input class="typeahead form-control" placeholder="Avanza, Xenia, Jazz, Alphard" type="text" />
                        </div>
                        <div class="form-group form-group-icon-left"><i class="fa fa-arrows-h input-icon input-icon-hightlight"></i>
                            <label>Kilometer</label>
                            <input class="typeahead form-control" placeholder="0 - %" type="text" />
                      </div>
                    </div>
                    <div class="col-md-4">
                ...
                <input class="btn btn-primary mt10" type="submit" value="Cari Mobil" />
            </form>
            <div class="gap"></div>
            <h3 class="mb20">Daftar Mobil</h3>
