...
<head>
    <title>Cari Kendaraan | Motor</title>
...
<body>
    ...
    @include('header')
        <div class="container">
            <h1 class="page-title">Cari Motor Impianmu</h1>
        </div>
        ...
        <div class="container">
            <form>
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group form-group-icon-left"><i class="fa fa-map-marker input-icon input-icon-hightlight"></i>
                            ...
                            <input class="typeahead form-control" placeholder="Satria, Jupiter, CBR, Blade" type="text" />
                        </div>
                ...
                <input class="btn btn-primary mt10" type="submit" value="Cari Motor" />
            </form>
            <div class="gap"></div>
            <h3 class="mb20">Daftar Motor</h3>
